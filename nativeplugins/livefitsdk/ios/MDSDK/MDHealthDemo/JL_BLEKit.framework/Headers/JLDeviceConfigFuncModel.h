...
/// 必须功能
@interface DeviceBasicFuncModel : NSObject
...
//MARK: - 系统功能
/// 系统功能
@interface DeviceSystemFuncModel : NSObject
...
//MARK: - 功能选项
/// 功能选项
@interface DeviceExportFuncModel : NSObject
/// 支持常用联系人
...
/// 手表综合功能支持
@interface HealthFuncComprehensive : NSObject
...
/// 手表运动模式支持功能
@interface HealthFuncSportModel : NSObject
/// 支持运动记录
...
/// 手表计步功能支持功能
@interface HealthFuncGSensorModel : NSObject
/// 是否存在该传感器
...
/// 手表心率功能支持功能
@interface HealthFuncHeartRateModel : NSObject
/// 是否存在该传感器
@property(nonatomic,assign)BOOL spExist;
/// 支持连续测试
...
/// 手表血氧功能支持功能
@interface HealthFuncBloodOxygenModel : NSObject
/// 是否存在该传感器
@property(nonatomic,assign)BOOL spExist;
...
/// 手表海拔功能支持功能
@interface HealthFuncAltitudeModel : NSObject
/// 是否存在该传感器
@property(nonatomic,assign)BOOL spExist;
...
/// 手表GPS功能支持功能
@interface HealthFuncGPSModel : NSObject
/// 是否存在该传感器
@property(nonatomic,assign)BOOL spExist;
...
@interface DeviceHealthFuncModel : NSObject

/// 手表综合功能支持
@property(nonatomic,strong)HealthFuncComprehensive *spComprehensive;
/// 手表运动模式支持功能
@property(nonatomic,strong)HealthFuncSportModel *spSportModel;
/// 手表计步功能支持功能
@property(nonatomic,strong)HealthFuncGSensorModel *spGSensor;
/// 手表心率功能支持功能
@property(nonatomic,strong)HealthFuncHeartRateModel *spHeartRate;
/// 手表血氧功能支持功能
@property(nonatomic,strong)HealthFuncBloodOxygenModel *spBloodOxygen;
/// 手表海拔功能支持功能
@property(nonatomic,strong)HealthFuncAltitudeModel *spAltitude;
/// 手表GPS功能支持功能
@property(nonatomic,strong)HealthFuncGPSModel *spGPS;
...
/// - 必须功能
@property(nonatomic,strong)DeviceBasicFuncModel *basicFunc;
/// - 系统功能
@property(nonatomic,strong)DeviceSystemFuncModel *systemFunc;
/// - 功能选项
@property(nonatomic,strong)DeviceExportFuncModel * exportFunc;
/// - 运动健康
@property(nonatomic,strong)DeviceHealthFuncModel *healthFunc;
/// 功能配置所属设备的UUID
