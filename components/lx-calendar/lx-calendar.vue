<template>
	<view class="date">
		<view class="head">
			<view style="margin-right: 40px;">帮助</view>
			...
			<view style="margin-left: 40px;" @click="huidaodata()">回到今天</view>
		</view>
		<view class="date_dl">
		...
		<swiper :style="{height:(retract ? 2 * 80 : (week_list.length + 1) * 80 ) + 'rpx'}" :current="current" circular
			@change="change_date">
			<swiper-item>
